...
def user_detail(username):
    ...
    reviews = Review.objects(commenter=user)  # Retrieve all reviews by the user
    review_count = reviews.count()  # Count the number of reviews
    
    return render_template('user_detail.html', user=user, image=image, review_db=reviews, review_count=review_count)
